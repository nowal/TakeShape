    ...
    <div className="p-8 pt-20">
      ...
      {currentStep === 1 && (
        <div className="flex flex-col gap-[26px]">
          ...
          <div className="flex flex-col py-9 px-6 bg-white rounded-2xl">
            ...
            <label
              htmlFor="title"
              className="block text-md font-medium text-gray-700 title-box flex justify-center items-center"
            >
              <input
                type="text"
                id="title"
      ...
      <div className="steps-box mb-40 max-w-3xl mx-auto text-left p-4 border rounded shadow-lg secondary-color">
        ...
        <ol className="list-decimal pl-4">
          <li>
            ...
            horizontally. Zoom out as far as possible.
          </li>
          <li>
            Go around the edge of the room as best as
            possible with camera facing the center. Move
            camera up and down occasionally to capture
            ceilings and trim.
          </li>
          <li>
            Walk through all areas that you would like
            painted, taking 15-30 seconds for each full
            room. You can exclude an area in your video from
