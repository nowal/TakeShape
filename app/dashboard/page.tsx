      ...
      >
        {prices.map((price, index) => {
          ...
          return (
            <div
              key={index}
              className="quote-item flex flex-col sm:flex-row items-center justify-between mb-5 p-3 border border-gray-300 rounded shadow-md"
            >
        ...
        <div className="dashboard-content flex flex-col items-center w-full max-w-4xl">
          ...
          {acceptedQuote ? (
            <div className="text-center my-10">
              ...
              />
              <h2 className="">
                They will reach out within two business days
                to schedule your job. If you have any
