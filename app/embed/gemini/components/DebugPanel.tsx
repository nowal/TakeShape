...
interface DebugPanelProps {
  ...
  displayedKeyframeId: number;
  numKeyframes: number;
  slamStatus: string;
  relocRequiredMsg: string | null;
  points: { [key: string]: { points: number[][], colors: number[][] } };
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ marginBottom: '4px' }}>
          <strong>Keyframes (Displayed/Total):</strong> {displayedKeyframeId} / {numKeyframes}
        </div>
        <div style={{ marginBottom: '4px' }}>
          <strong>SLAM Mode:</strong> {slamStatus}
        </div>
        <div style={{ marginBottom: '4px' }}>
          <strong>Points:</strong> {Object.keys(points).length}
        </div>
        {relocRequiredMsg && (
          <div style={{ 
            color: 'orange', 
