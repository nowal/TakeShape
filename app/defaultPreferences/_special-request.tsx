...
export const DefaultPreferencesSpecialRequest: FC<TProps> = ({classValue, ...props}) => {
  return (
      <label className="flex flex-col items-center gap-2 w-full">
            ...
            <motion.textarea
              ...
              rows={3}
              className={cx("rounded-lg border border-white-3 bg-white-2 w-full px-4.5 py-3.5 outline-none", classValue)}
              {...props}
            />
          </label>
  );
